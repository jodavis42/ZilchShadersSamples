...
FrameworkZilchShaderGlslBackend::FrameworkZilchShaderGlslBackend()
{
  mTargetVersion = 150;
  mTargetGlslEs = false;
}

String FrameworkZilchShaderGlslBackend::GetExtension()
{
  return "glsl";
}

bool FrameworkZilchShaderGlslBackend::RunTranslationPass(ShaderTranslationPassResult& inputData, ShaderTranslationPassResult& outputData)
{
...
String FrameworkZilchShaderGlslBackend::GetErrorLog()
{
  return mErrorLog;
}
